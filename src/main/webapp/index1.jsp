...
<title>Amazon Market Place Immersion Project</title>
  ...
  <div class="container-fluid">
    ...
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="#">
        <img alt="Brand" src="assets/img/aws-marketplace2.jpg" height=30 width=40>
      </a>
      <a class="navbar-brand" href="#">Amazon Marketplace Immersion Project</a>
    </div>
				...
				<div class="panel panel-primary">
                        ...
                        <div class="panel panel-primary">
                            ...
                            <a href="#">
                                <div class="panel-footer">
                                    <span class="pull-left">link 1</span>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="panel panel-green">
                            <div class="panel-heading">
                            Generate Incremental Data</div>
                            <a href="#">
                                <div class="panel-footer">
                                    <span class="pull-left">link 2</span>
                                    <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                                    <div class="clearfix"></div>
                                </div>
                            </a>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="panel panel-yellow">
                            ...
                            <a href="#">
                                <div class="panel-footer">
                                    <span class="pull-left">link 3</span>
                                    <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                                    <div class="clearfix"></div>
                                </div>
                            </a>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="panel panel-red">
                            ...
                            <a href="#">
                                <div class="panel-footer">
                                    <span class="pull-left">link 4</span>
                                    <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                                    <div class="clearfix"></div>
                                </div>
                            </a>
